...
export const typologies = [
  {
    ...
    surfaceShortFr: 'À partir de 68 m²',
    surfaceShortAr: 'ابتداءً من 68 م²',
    roomsFr: '2 chambres',
    roomsAr: 'غرفتان',
    bathsFr: '1 salle de bain',
    bathsAr: 'حمام واحد',
  ...
  },
  {
    ...
    surfaceShortFr: 'À partir de 77 m²',
    surfaceShortAr: 'ابتداءً من 77 م²',
    roomsFr: '3 chambres',
    roomsAr: 'ثلاث غرف',
    bathsFr: '1 salle de bain + WC',
    bathsAr: 'حمام ومرحاض',
    priceFr: 'à partir de 420 000 DH',
    priceAr: 'ابتداءً من 420 000 درهم',
    bodyFr:
  ...
  },
  {
    ...
    surfaceShortFr: 'De 13 à 30 m²',
    surfaceShortAr: 'من 13 إلى 30 م²',
    roomsFr: '49 lots',
    roomsAr: '49 محلاً',
    bathsFr: 'Rez-de-chaussée',
    bathsAr: 'الطابق الأرضي',
...
export const galleryImages = Array.from({ length: 12 }, (_, i) => ({
  ...
  altAr: `منظر مشروع رياض زعير غاردنز في عين عودة — صورة ${i + 1}`,
}));
